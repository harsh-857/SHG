    ...
    return (
        <div>
            ...
            <div className="card">
                ...
                <p>This platform connects local citizens with Self Help Groups (SHGs) providing essential services like Tailoring, Housekeeping, Cooking, Baby Sitting, and more.</p>
            </div>
